...
- **이는 이는 고객이 돈을 잃어서 떠나기보다, 서비스를 지속하는 것에 대한 흥미나 동기부여가 부족해서 떠난다는 것을 예측해볼 수 있음**

## 분석 결과 요약
EDA 분석 결과, 고객의 이탈은 단순한 금전적 손실(ROI)보다는 **초기 활동의 연속성**과 **서비스 경험의 다양성 부재**에서 나타남을 확인
