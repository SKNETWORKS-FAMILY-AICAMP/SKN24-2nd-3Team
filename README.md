...
# 7. ℹ️ EDA 시각화 및 분석 인사이트

<img src="assets/이탈률 그래프.png" width="600" alt="고객 이탈 비율 및 빈도 그래프">
...
<img src="assets/churn과 상관관계.png" width="600" alt="이탈과 변수의 상관관계">
total_active_days (-0.35)와 fixed_active_days (-0.34)가 가장 강한 음의 상관관계를 보이고 있음

<img src="assets/이탈과 boxplot.png" width="600" alt="이탈과 변수의 상관관계">

잔존 유저의 중앙값은 약 35일 근처인 반면, 이탈 유저는 10일 미만에 매우 낮게 형성되어 있음
이는 대부분의 이탈자가 가입 초기에 서비스를 떠났음을 의미함
...
<img src="assets/활동유저비율.png" width="600" alt='활동유저비율">
...
<img src="assets/베팅 유형별 이탈률.pngg" width="600" alt='베팅 유형별 이탈률">

여러 유형의 베팅을 하는 유저가 가장 낮은 이탈률(19.5%)을 기록함 이는 다양한 서비스가 고객의 이탈을 막는 것으로 볼 수 있음
